USE [master]
GO
/****** 对象:  Database [QPGameScoreDB]    脚本日期: 01/23/2008 14:55:34 ******/
IF NOT EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'QPGameScoreDB')
BEGIN
CREATE DATABASE [QPGameScoreDB]
END
