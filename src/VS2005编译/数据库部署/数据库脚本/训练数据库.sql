USE [master]
GO
/****** 对象:  Database [QPEducateDB]    脚本日期: 01/23/2008 14:55:34 ******/
IF NOT EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'QPEducateDB')
BEGIN
CREATE DATABASE [QPEducateDB]
END

GO
ALTER DATABASE [QPEducateDB] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [QPEducateDB] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [QPEducateDB] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [QPEducateDB] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [QPEducateDB] SET ARITHABORT OFF 
GO
ALTER DATABASE [QPEducateDB] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [QPEducateDB] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [QPEducateDB] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [QPEducateDB] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [QPEducateDB] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [QPEducateDB] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [QPEducateDB] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [QPEducateDB] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [QPEducateDB] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [QPEducateDB] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [QPEducateDB] SET  READ_WRITE 
GO
ALTER DATABASE [QPEducateDB] SET RECOVERY FULL 
GO
ALTER DATABASE [QPEducateDB] SET  MULTI_USER 
GO
if ( ((@@microsoftversion / power(2, 24) = 8) and (@@microsoftversion & 0xffff >= 760)) or 
		(@@microsoftversion / power(2, 24) >= 9) )begin 
	exec dbo.sp_dboption @dbname =  N'QPEducateDB', @optname = 'db chaining', @optvalue = 'OFF'
 end
