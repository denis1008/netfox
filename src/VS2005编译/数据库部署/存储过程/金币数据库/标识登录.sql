...
BEGIN
	...
	SELECT @UserID AS UserID, @GameID AS GameID, @GroupID AS GroupID, @Accounts AS Accounts, @UnderWrite AS UnderWrite, @FaceID AS FaceID, 
		@Gender AS Gender, @GroupName AS GroupName, @MasterOrder AS MasterOrder, @UserRight AS UserRight, @MasterRight AS MasterRight, 
		@MemberOrder AS MemberOrder, @WinCount AS WinCount, @LostCount AS LostCount, 
