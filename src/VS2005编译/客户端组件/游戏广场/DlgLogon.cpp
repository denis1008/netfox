...
BOOL CDlgRegister::OnInitDialog()
{
	...
	m_LineRegWeb.SetHyperLinkUrl(TEXT("http://218.23.50.5"));
	m_LineMainPage.SetHyperLinkUrl(TEXT("http://218.23.50.5"));
	m_LinePassWord.SetHyperLinkUrl(TEXT("http://218.23.50.5"));
...
BOOL CDlgLogon::OnInitDialog()
{
	...
	m_LineMainPage.SetHyperLinkUrl(TEXT("http://218.23.50.5"));
	m_LinePassWord.SetHyperLinkUrl(TEXT("http://218.23.50.5"));
	m_LineGetPassWord.SetHyperLinkUrl(TEXT("http://218.23.50.5"));
...
void CDlgLogon::LoadLogonServer()
{
	...
	{
		pComBoxServer->AddString(TEXT("218.23.50.5"));
...
void CDlgLogon::OnRegisterAccounts()
{
	...
	//服务器
	GetDlgItemText(IDC_SERVER,m_strLogonServer);
	if (m_strLogonServer.IsEmpty()) m_strLogonServer=TEXT("218.23.50.5");
