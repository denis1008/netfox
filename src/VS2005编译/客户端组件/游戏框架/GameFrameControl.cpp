...
BOOL CGameFrameControl::OnInitDialog()
{
	...
	m_BrowerAD.Navigate(TEXT("http://www.huanlegame.com/AD/GameFrameAD.asp"),NULL,NULL,NULL,NULL);
...
{
	TCHAR szRuleUrl[128];
	_snprintf(szRuleUrl,sizeof(szRuleUrl),TEXT("http://www.huanlegame.com/GameRule.asp?KindID=%ld"),m_UserListView.m_wKindID);
...
void CGameFrameControl::RectifyControl(int nWidth, int nHeight)
{
	...
	//广告区域
	DeferWindowPos(hDwp,m_BrowerAD,NULL,LIST_LEFT,7,nWidth-LIST_LEFT-LIST_RIGHT,65,uFlags);
