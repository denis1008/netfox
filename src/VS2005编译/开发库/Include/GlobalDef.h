...
const TCHAR	szProductName[]		= TEXT("游戏中心");			//产品名字
const TCHAR	szSystemRegKey[]	= TEXT("GameHall");			//注册主键
const TCHAR	szStationPage[]		= TEXT("www.21898.com");	//游戏主页
...
#define MAIN_DLG_CLASSNAME	TEXT("GameHallWnd")				//窗口注册名
...
struct tagGameType
{
	...
	char *GetTypeName() {return "tagGameType";}
};
...
struct tagGameKind
{
	...
	char *GetTypeName() {return "tagGameKind";}
...
struct tagGameStation
{
	...
	char *GetTypeName() {return "tagGameStation";}
...
struct tagGameServer
{
	...
	char *GetTypeName() {return "tagGameServer";}
};
