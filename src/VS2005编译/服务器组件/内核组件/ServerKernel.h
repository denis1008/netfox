...
//////////////////////////////////////////////////////////////////////////
	...
	static const GUID IID_IADOError={0x578c08bb,0x9aae,0x4686,0xa0,0x56,0xa6,0x95,0x14,0x82,0xcd,0x51};
#else
	#define VER_IADOError INTERFACE_VERSION(1,1)
	static const GUID IID_IADOError={0x7741cbd5,0xb949,0x43fa,0xb6,0x21,0x16,0x46,0xd3,0x80,0xb9,0xdc};
#endif
...
//////////////////////////////////////////////////////////////////////////
	...
	static const GUID IID_IDataBase={0xdd9a23aa,0xc5c6,0x48b1,0xbb,0xea,0x6f,0x82,0xde,0x2b,0xf7,0x48};
#else
	#define VER_IDataBase INTERFACE_VERSION(1,1)
	static const GUID IID_IDataBase={0xda293410,0xef36,0x41ef,0x8b,0x5f,0x6e,0x65,0xb8,0x0d,0xb9,0x13};
#endif
...
interface IDataBase : public IUnknownEx
{
	...
	//获取参数
	virtual bool __cdecl GetFieldValue(LPCTSTR lpFieldName, LONGLONG & llValue)=NULL;
	//获取参数
	virtual bool __cdecl GetFieldValue(LPCTSTR lpFieldName, COleDateTime & Time)=NULL;
	//获取参数
	//virtual UINT __cdecl GetFieldValue(LPCTSTR lpFieldName, BYTE cbBuffer[], UINT uSize)=NULL;
	//获取参数
...
//////////////////////////////////////////////////////////////////////////
	...
	static const GUID IID_IQueueService={0x1511c94b,0x1dfd,0x42e2,0xbc,0x51,0x06,0x88,0x05,0x85,0x4e,0x89};
#else
	#define VER_IQueueService INTERFACE_VERSION(1,1)
	static const GUID IID_IQueueService={0x91d38789,0x3c5f,0x4483,0x85,0x73,0x12,0x30,0x6e,0xf5,0x29,0x87};
#endif
...
{
	//设置定时器
	virtual bool __cdecl SetTimer(DWORD dwTimerID, DWORD dwElapse, DWORD dwRepeat, WPARAM wParam)=NULL; 
	//删除定时器
