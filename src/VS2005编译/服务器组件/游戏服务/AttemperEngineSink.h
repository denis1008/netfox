...
private:
	...
	//用户信息
	bool OnDBAndroidUser(void * pDataBuffer, WORD wDataSize, NTY_DataBaseEvent * pDataBaseEvent);
	//赠送结果
	bool OnDBSendGiftResult(void * pDataBuffer, WORD wDataSize, NTY_DataBaseEvent * pDataBaseEvent);
...
protected:
	...
	//赠送处理
	bool OnSendGift(WORD wSubCmdID, const void * pDataBuffer, WORD wDataSize, IServerUserItem * pIServerUserItem);
};
